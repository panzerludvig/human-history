...
_See [[Meta/Open Threads]]. The smallest loop that can be played and judged._

## Core Concepts
- [[Design/Core Concepts]] — what the game is built from

## References / Inspirations
- Delegate (https://github.com/panzerludvig/delegate) — predecessor; see [[Meta/Inherited from Delegate]]
