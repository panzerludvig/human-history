...
**How much a person drinks is not a constant** (2026-08-31): two or three litres a day at rest in cool country, four to six walking in tropical heat, more than ten in a desert. `population::thirstFactor` scales the need from 1 at 12 degC to 2.2 at 36, so three days of skins is under two days in the south -- and hot country stops being the easier crossing, which it was when every band drank the same everywhere. (Standing on a known hot bias in the climate model, recorded 2026-08-31: peak seasonal means run 15-20 degC above life, so thirst is currently overstated everywhere and most in the far north.)
