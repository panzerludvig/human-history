...
**Scarcity you can see** (fixed 2026-08-26): the trigger was phi, built from *annual-mean* food, but starvation is seasonal -- the store empties in the lean season and kills, then refills, while the yearly average reads comfortable throughout. A settlement could therefore bury people every winter, decline steadily, and never once reach the question: above phi 0.99 the decision clears the scarcity clock and returns. Losing more than 2% of its people to hunger in a trailing year now counts as scarcity in its own right, whatever the mean says, and the same signal feeds need-driven invention and the early wake -- a place that kills people every winter is exactly where farming and granaries came from. Panels show "Hunger: N lost this year"; its absence was what made this invisible.
