...
- `src/water2geo.h` — the water in two layers on the mesh (`WATER2`, `sweep.exe earth 0 geow 1`): lower and upper vapour on the two QG winds, the lift between them from the model's interface velocity plus terrain and the painted tropical ascent, each layer condensing at its own saturation with the rate scaled by the ascent and the ceiling raised by descent. First Earth year of it (2026-09-08): global column 24.3 mm and residence 8.8 days against Earth's 25 and 9; Western Europe 2.4, Eastern Europe 1.5, the boreal belt 1.0, India 4.1 and Southeast Asia 8.1 mm/day against 2.2, 1.6, 1.2, 3.0 and 5.0. Still wrong: high ground rains from the hard ceiling because the layer's capacity follows the cold painted surface air at altitude, so every plateau is wet (Mexico 10.5, Patagonia 9.3, the Great Basin 3.0, Northwest Africa 3.7 against 1.2, 0.6, 0.7, 1.2); the Pacific Northwest stays at 1.8 against 3.5 because the template's Cascades are 800 m and the Rockies take the water instead.
