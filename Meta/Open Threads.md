...
**Decided 2026-09-08: nothing painted but the land.** The terrain is the only input; the painted climate may set the state once, at the first hour, and after that no climate field is set by anything but the equations (`PAINT_INIT`, `sweep.exe earth 0 physgeo 1`). What that gives on Earth today, and what it still gets wrong, is in [[Design/Weather]] (decision of 2026-09-08) and [[Technical/Geodesic Grid]]. The rest of this thread is the history.
